...
1) [Try to prettyprint the book record in JSON. Fill out the blanks `...` with the correct option.](https://metafacture.org/playground/?flux=%22https%3A//openlibrary.org/books/OL2838758M.json%22%7C+open-http%0A%7C+as-lines%0A%7C+decode-json%0A%7C+encode-json%28...%29%0A%7C+write%28%22test.xml%22%29%0A%3B)

<details>
<summary>Answer</summary>
Add the option: <code>prettyPrinting="true"</code> to the <code>encode-json</code>-command.
</details>
...
The signature of <code>decode-xml</code> and <code>decode-json</code> is quiet differnet.
<code>decode-xml</code>: signature: Reader -> XmlReceiver
