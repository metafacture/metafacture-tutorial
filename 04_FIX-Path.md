...
If you want to refer to all creators then you can use the array wildcard `*` which can replace the concrete index number: `creator.*` refers to all creator elements. 
